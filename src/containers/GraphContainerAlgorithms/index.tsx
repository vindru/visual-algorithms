...
import { NodeTypeButtonType, WALL_NODE_BUTTON } from '../../utils/types/graph-types/node-type-button-type';
...
const GraphContainerAlgorithms = (props: GraphContainerAlgorithmsProps): JSX.Element => {
    ...
    const [activeNodeType, setActiveNodeType] = React.useState(WALL_NODE_BUTTON as NodeTypeButtonType);
